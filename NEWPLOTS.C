...
void NEWPLOTS( Int_t nrun=1372) {
    ...
    TChain *t;
    TFile *f = new TFile(Form("../../ROOTfiles/nps_eel108_%i_latest.root", nrun));
    t = new TChain("T");
    t->Add(f->GetName(),-1);
    ...
    TFile *F1= new TFile(Form("../../ROOTfiles/histogram/HISTOGRAM_NPS_%i.root",nrun),"UPDATE");
